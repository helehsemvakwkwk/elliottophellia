...
# Fungsi untuk mendapatkan konfigurasi jika belum ada
def get_config():
    config = load_config()
    if config is None:
        os.system('clear')
        print(Fore.GREEN + "Konfigurasi pertama kali diperlukan.")
        domain = input("Masukkan Domain: ")
        port = input("Masukkan Port: ")
        username = input("Masukkan Username: ")
        password = input("Masukkan Password: ")
        https = input("Gunakan HTTPS? (y/n): ").lower() == 'y'
...
if token:
    os.system('clear')
    print(Fore.YELLOW + "###########################################")
    print(Fore.YELLOW + "#####" + Fore.RED + "   SKARTI x AWN EzZzTemplate v6.9  " + Fore.YELLOW + "#####")
    print(Fore.YELLOW + "#####" + Fore.GREEN + "       Build Semvak Project      " + Fore.YELLOW + "#####")
    print(Fore.YELLOW + "###########################################\n")
    print(Fore.WHITE + "ini adalah Ezz bikin " + Fore.GREEN + "template " + Fore.WHITE + "Otomatis" )
    print("setelah bikin template, tinggal " + Fore.GREEN + "aktifkan bot")
    print("lalu di bot, pilih " + Fore.GREEN + "Create User From Template")   
    #print(Fore.CYAN + "Welcome To The Script (Developed By AML)")   
    while True:
        menu = input("""
...
Enter a Number to continue : """)
        if menu == "1":
            ...
            vmess_inbounds = []
            while True:
                print("Enter your VMESS inbound names." + Fore.GREEN + "( You Can Type '/' To Select All )")
            ...
            vless_inbounds = []
            while True:
                print("Enter your VLESS inbound names." + Fore.GREEN + "( You Can Type '/' To Select All )")
            ...
            trojan_inbounds = []
            while True:
                print("Enter your TROJAN inbound names." + Fore.GREEN + "( You Can Type '/' To Select All )")
            ...
            while True:
                print("Enter your SHADOWSOCKS inbound names." + Fore.GREEN + "( You Can Type '/' To Select All )")
